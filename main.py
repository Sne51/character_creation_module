...
def attack(char_name: str, char_class: str) -> str:
    """Describe the attack parameters of the characther."""
...
def defence(char_name: str, char_class: str) -> str:
    """Describe the defence parameters of the characther."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Describe the special abilities of the characther."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Describe the trainin process of the characther."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'warrior':
            print(
                """оитель — дерзкий воин ближнего боя.
...
def main() -> None:
    ...
    while approve_choice != 'y':
        ...
        Лекарь — healer: """)
        if char_class == 'warrior':
            print("""оитель — дерзкий воин ближнего боя.
            Сильный, выносливый и отважный.""")
        if char_class == 'mage':
